import { useState } from "react"; import axios from "axios"; import { FaSearch, 
    FaCheckCircle, FaTimesCircle } from "react-icons/fa"; 
           const SearchChallan = () => { 
              ...
              const handleSearch = async () => { 
                ...
                try { 
                  const { data } = await axios.get(`http://localhost:5000/api/challans/search/${vehicleNumber}`); 
                  setChallan(data); 
                } catch (error) { 
                      ...
                      <div className="mt-3"> 
                        ...
                        <p> 
                          ...
                          {challan.isPaid ? ( 
                            ...
                            <span className="text-danger"> <FaTimesCircle /> Pending</span> 
                          )} 
                        </p> 
                      </div> 
                    )} 
